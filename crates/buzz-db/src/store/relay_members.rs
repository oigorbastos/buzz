...
impl Db {
    ...
    /// Returns whether the durable NIP-43 membership snapshot needs rebuilding.
    ...
    pub async fn publish_nip43_membership_locked(
        ...
        let lock_key = crate::runtime::event_replacement_lock_key(
            community_id,
            kind_i32,
