...
import { ChannelScreenDialogs } from "@/features/channels/ui/ChannelScreenDialogs";
...
import { MessageTaskToggleProvider } from "@/features/messages/lib/useMessageTaskToggleBatch";
import {
  getThreadReference,
  isThreadReply,
    ...
    <AgentSessionProvider onOpenAgentSession={handleOpenAgentSession}>
      <ProfilePanelProvider onOpenProfilePanel={handleOpenProfilePanel}>
        <ChannelScreenDialogs
          emptyDeleteId={emptyDeleteId}
          guideName={welcomeGuideAgent?.name ?? "your welcome guide"}
          isWelcomeAgentCreateOpen={welcomeAgentCreate.isOpen}
          isWelcomeAgentCreateSending={welcomeAgentCreate.isSending}
          onCreateWelcomeAgentInChat={() =>
            void welcomeAgentCreate.createInChat()
          }
          onCreateWelcomeAgentManually={welcomeAgentCreate.createManually}
          onDeleteMessage={handleDelete}
          onEditTargetChange={setEditTargetId}
          onEmptyDeleteIdChange={setEmptyDeleteId}
          onWelcomeAgentCreateOpenChange={welcomeAgentCreate.setIsOpen}
          welcomeAgentCreateError={welcomeAgentCreate.error}
        />
        <div
            ...
            activeChannel.channelType === "forum" ? (
              ...
              >
                <MessageTaskToggleProvider
                  ...
                  updateMessage={editMessageMutation.mutateAsync}
                >
