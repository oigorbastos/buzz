...
function MessageComposerImpl({
  ...
  const applyChannelInsert = React.useCallback(
    (suggestion: ChannelSuggestion) => {
      applyLinkInsert({ kind: "channel", suggestion });
    },
    [applyLinkInsert],
  );
  const applyLabBoardInsert = React.useCallback(
    (suggestion: LabBoardSuggestion) => {
      applyLinkInsert({ kind: "lab-board", suggestion });
    },
    [applyLinkInsert],
  );
          ...
          >
            ...
            {composerOwnsFocus ? (
              <LabBoardAutocomplete
                onSelect={applyLabBoardInsert}
                selectedIndex={composerLinks.labLinks.labBoardSelectedIndex}
                suggestions={
                  composerLinks.labLinks.isLabBoardOpen
                    ? composerLinks.labLinks.labBoardSuggestions
                    : []
                }
              />
            ) : null}
